...
contract KnowledgeLayerArbitrator is Arbitrator {
     ...
     */
    constructor(address _knowledgeLayerPlatformIdAddress) {
    ...
    function giveRuling(uint256 _disputeID, uint256 _ruling) public {
        ...
        require(
            msg.sender == knowledgeLayerPlatformId.ownerOf(dispute.platformId),
